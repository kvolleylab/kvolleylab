...
const improve=()=>{
  ...
  if(!root.querySelector('.cd-source-guide'))root.insertAdjacentHTML('afterend','<p class="cd-source-guide" style="margin:12px 0 0;color:#64748b;font-size:12px;line-height:1.6">HWP 경기일정표는 Google Drive 미리보기가 지원되지 않아 파일 다운로드 방식으로 제공합니다. 파일은 한컴오피스 또는 HWP 뷰어에서 열 수 있습니다.</p>');
  return true;
};
