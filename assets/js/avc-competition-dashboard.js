(()=>{
  ...
  Promise.all([
    ...
    document.getElementById('avcBracket').innerHTML=`<div class="avc-bracket-main"><div class="avc-ladder-final"><div class="avc-ladder-label">결승</div>${bracketMatch(28219,'결승')}</div><div class="avc-bracket-connector" aria-hidden="true"><i class="v-top"></i><i class="h-merge"></i><i class="v-left"></i><i class="v-right"></i></div><div class="avc-ladder-semi avc-ladder-semi-1"><div class="avc-ladder-label">준결승 1</div>${bracketMatch(28214,'준결승 1')}</div><div class="avc-ladder-semi avc-ladder-semi-2"><div class="avc-ladder-label">준결승 2</div>${bracketMatch(28215,'준결승 2')}</div></div><aside class="avc-bracket-side"><div class="avc-ladder-third"><div class="avc-ladder-label">3·4위 결정전</div>${bracketMatch(28218,'3·4위 결정전')}</div></aside>`;
