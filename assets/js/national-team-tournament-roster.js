(()=>{
  ...
  async function loadAvcMenCup(){
    const [master,indexData,rosterData,extendedData,extendedData2,extendedData3]=await Promise.all([
    ...
    const teams=[...((extendedData3&&extendedData3.teams)||[]),...(rosterData.teams||[]),...((extendedData&&extendedData.teams)||[]),...((extendedData2&&extendedData2.teams)||[])];
