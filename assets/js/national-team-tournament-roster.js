(()=>{
  ...
  async function loadAvcMenCup(){
    const [master,indexData,rosterData,extendedData,extendedData2,extendedData3,extendedData4,extendedData5,extendedData6,extendedData7]=await Promise.all([
      ...
      fetchOptionalJson('data/competition/avc-men-cup-2026-men-rosters-verified-6.json'),
      fetchOptionalJson('data/competition/avc-men-cup-2026-men-rosters-verified-7.json'),
      fetchOptionalJson('data/competition/avc-men-cup-2026-men-rosters-verified-8.json')
    ]);
    ...
    const teams=[...((extendedData7&&extendedData7.teams)||[]),...((extendedData6&&extendedData6.teams)||[]),...((extendedData5&&extendedData5.teams)||[]),...((extendedData4&&extendedData4.teams)||[]),...((extendedData3&&extendedData3.teams)||[]),...(rosterData.teams||[]),...((extendedData&&extendedData.teams)||[]),...((extendedData2&&extendedData2.teams)||[])];
