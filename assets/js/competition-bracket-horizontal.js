...
function enhanceChampion(){
  ...
  const name=champion.querySelector('strong');
  if(name&&!name.textContent.trim().startsWith('우승 '))name.textContent=`우승 ${name.textContent.trim()}`;
  if(!champion.querySelector('.cd-champion-trophy')){
    const trophy=document.createElement('span');
    trophy.className='cd-champion-trophy';
    trophy.textContent='🏆';
    champion.insertBefore(trophy,champion.firstChild);
  }
...
function apply(){
  ...
  if(!document.getElementById(styleId)){
    ...
    style.id=styleId;
    style.textContent=`
      .cd-pyramid{min-width:980px!important;max-width:1120px!important;padding:6px 24px 28px!important}
      ...
      .cd-pyramid-row.is-entries{grid-template-columns:180px 260px 180px 260px!important;justify-content:center!important;gap:24px!important;margin-top:98px!important}
      .cd-pyramid-row.is-entries .cd-direct-card{width:180px!important}
      .cd-pyramid-row.is-entries .cd-bracket-game{width:260px!important}
      .cd-champion{display:flex!important;align-items:center!important;gap:10px!important;min-width:0!important;padding:10px 22px!important;border:2px solid #c9a24a!important;border-radius:999px!important;background:#17365d!important;color:#fff!important;box-shadow:0 12px 28px rgba(23,54,93,.18)!important}
      ...
      .cd-champion strong{color:#fff!important;font-size:20px!important;white-space:nowrap!important}
      ...
      .cd-pyramid-row.is-entries .cd-horizontal-side strong{font-size:13px}
      ...
      @media(max-width:760px){.cd-pyramid{min-width:980px!important}.cd-pyramid-row.is-semis{gap:72px!important}.cd-pyramid-row.is-entries{grid-template-columns:170px 250px 170px 250px!important;gap:14px!important}.cd-pyramid-row.is-entries .cd-direct-card{width:170px!important}.cd-pyramid-row.is-entries .cd-bracket-game{width:250px!important}}
    `;
